// ═══════════════════════════════════════════════════════════════════════════
// QOMN v3.1 — WebAssembly (WASM) Backend
// Emits WebAssembly Text Format (WAT) from QOMN oracle definitions.
...
pub fn oracle_to_wat(oracle: &OracleDecl) -> String {
    ...
    out.push(format!(";; QOMN v3.1 WAT — oracle: {}", oracle.name));
    out.push(";; Generated by qomn wasm_backend".into());
